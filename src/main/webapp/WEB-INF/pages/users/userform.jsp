	...
	<form:form class="form-horizontal" method="post"
				...
				<div class="col-sm-5">
					<form:select path="country" class="form-control">
						...
						<option value="Ã…land Islands"
							...
							data-relevancy-booster="0.5">Aland Islands</option>
						<option value="Albania" data-alternative-spellings="AL">Albania</option>
						<option value="Algeria"
							data-alternative-spellings="DZ Ø§Ù„Ø¬Ø²Ø§Ø¦Ø±">Algeria</option>
						...
						<option value="Antigua And Barbuda"
							data-alternative-spellings="AG" data-relevancy-booster="0.5">Antigua
							And Barbuda</option>
						<option value="Argentina" data-alternative-spellings="AR">Argentina</option>
						<option value="Armenia"
							data-alternative-spellings="AM Õ€Õ¡ÕµÕ¡Õ½Õ¿Õ¡Õ¶">Armenia</option>
						...
						<option value="Bahrain"
							data-alternative-spellings="BH Ø§Ù„Ø¨Ø­Ø±ÙŠÙ†">Bahrain</option>
						<option value="Bangladesh"
							data-alternative-spellings="BD à¦¬à¦¾à¦‚à¦²à¦¾à¦¦à§‡à¦¶"
							data-relevancy-booster="2">Bangladesh</option>
						<option value="Barbados" data-alternative-spellings="BB">Barbados</option>
						<option value="Belarus"
							data-alternative-spellings="BY Ð‘ÐµÐ»Ð°Ñ€ÑƒÑ�ÑŒ">Belarus</option>
						...
						<option value="Bhutan"
							data-alternative-spellings="BT à¤­à¥‚à¤Ÿà¤¾à¤¨">Bhutan</option>
						...
						<option value="Bosnia and Herzegovina"
							data-alternative-spellings="BA BiH Bosna i Hercegovina Ð‘Ð¾Ñ�Ð½Ð° Ð¸ Ð¥ÐµÑ€Ñ†ÐµÐ³Ð¾Ð²Ð¸Ð½Ð°">Bosnia
						...
						<option value="Bulgaria"
							data-alternative-spellings="BG Ð‘ÑŠÐ»Ð³Ð°Ñ€Ð¸Ñ�">Bulgaria</option>
						...
						<option value="Cambodia"
							data-alternative-spellings="KH áž€áž˜áŸ’áž–áž»áž‡áž¶">Cambodia</option>
						...
						<option value="Chad"
							data-alternative-spellings="TD ØªØ´Ø§Ø¯â€Ž Tchad">Chad</option>
						...
						<option value="Comoros"
							data-alternative-spellings="KM Ø¬Ø²Ø± Ø§Ù„Ù‚Ù…Ø±">Comoros</option>
						...
						<option value="CÃ´te d'Ivoire"
							data-alternative-spellings="CI Cote dIvoire">Cote
							d'Ivoire</option>
						...
						<option value="Czech Republic"
							data-alternative-spellings="CZ ÄŒeskÃ¡ Ceska">Czech
							Republic</option>
						...
						<option value="Eritrea"
							data-alternative-spellings="ER Ø¥Ø±ØªØ±ÙŠØ§ áŠ¤áˆ­á‰µáˆ«">Eritrea</option>
						<option value="Estonia" data-alternative-spellings="EE Eesti">Estonia</option>
						<option value="Ethiopia"
							data-alternative-spellings="ET áŠ¢á‰µá‹®áŒµá‹«">Ethiopia</option>
						...
						<option value="Fiji"
							data-alternative-spellings="FJ Viti à¤«à¤¼à¤¿à¤œà¥€">Fiji</option>
						...
						<option value="Georgia"
							data-alternative-spellings="GE áƒ¡áƒ�áƒ¥áƒ�áƒ áƒ—áƒ•áƒ”áƒšáƒ�">Georgia</option>
						...
						<option value="Greece"
							data-alternative-spellings="GR Î•Î»Î»Î¬Î´Î±"
							data-relevancy-booster="1.5">Greece</option>
						<option value="Greenland"
							data-alternative-spellings="GL grÃ¸nland"
						...
						<option value="Heard Island and McDonald Islands"
							data-alternative-spellings="HM">Heard Island and
						...
						<option value="Hungary"
							data-alternative-spellings="HU MagyarorszÃ¡g">Hungary</option>
						...
						<option value="Iran, Islamic Republic of"
							...
							Republic of</option>
						<option value="Iraq"
							data-alternative-spellings="IQ Ø§Ù„Ø¹Ø±Ø§Ù‚â€Ž">Iraq</option>
						...
						<option value="Israel"
							data-alternative-spellings="IL Ø¥Ø³Ø±Ø§Ø¦ÙŠÙ„ ×™×©×¨×�×œ">Israel</option>
						...
						<option value="Jordan"
							data-alternative-spellings="JO Ø§Ù„Ø£Ø±Ø¯Ù†">Jordan</option>
						...
						<option value="Kuwait"
							data-alternative-spellings="KW Ø§Ù„ÙƒÙˆÙŠØª">Kuwait</option>
						...
						<option value="Macedonia, The Former Yugoslav Republic Of"
							data-alternative-spellings="MK ÐœÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ˜Ð°">Macedonia,
						...
						<option value="Moldova, Republic of"
							data-alternative-spellings="MD">Moldova, Republic of</option>
						...
						<option value="Morocco"
							data-alternative-spellings="MA Ø§Ù„Ù…ØºØ±Ø¨">Morocco</option>
						...
						<option value="Nepal"
							data-alternative-spellings="NP à¤¨à¥‡à¤ªà¤¾à¤²">Nepal</option>
						...
						<option value="New Zealand"
							data-alternative-spellings="NZ Aotearoa">New Zealand</option>
						...
						<option value="Pakistan"
							data-alternative-spellings="PK Ù¾Ø§Ú©Ø³ØªØ§Ù†"
						...
						<option value="Saint Kitts and Nevis"
							data-alternative-spellings="KN St.">Saint Kitts and
							Nevis</option>
						...
						<option value="Sint Maarten (Dutch Part)"
							data-alternative-spellings="SX">Sint Maarten (Dutch
							Part)</option>
						...
						<option value="Somalia"
							data-alternative-spellings="SO Ø§Ù„ØµÙˆÙ…Ø§Ù„">Somalia</option>
						...
						<option value="Sri Lanka"
							...
							Lanka</option>
						<option value="Sudan"
							data-alternative-spellings="SD Ø§Ù„Ø³ÙˆØ¯Ø§Ù†">Sudan</option>
						...
						<option value="Syrian Arab Republic"
							data-alternative-spellings="SY Syria Ø³ÙˆØ±ÙŠØ©">Syrian
							Arab Republic</option>
						<option value="Taiwan, Province of China"
							data-alternative-spellings="TW å�°ç�£ è‡ºç�£">Taiwan,
							Province of China</option>
						<option value="Tajikistan"
							data-alternative-spellings="TJ Ð¢Ð¾Ò·Ð¸ÐºÐ¸Ñ�Ñ‚Ð¾Ð½ ToÃ§ikiston">Tajikistan</option>
						<option value="Tanzania, United Republic of"
							data-alternative-spellings="TZ">Tanzania, United
							Republic of</option>
						...
						<option value="Trinidad and Tobago"
							data-alternative-spellings="TT">Trinidad and Tobago</option>
						...
						<option value="United Arab Emirates"
							data-alternative-spellings="AE UAE Ø§Ù„Ø¥Ù…Ø§Ø±Ø§Øª">United
						...
						<option value="Virgin Islands, U.S."
							data-alternative-spellings="VI" data-relevancy-booster="0.5">Virgin
							Islands, U.S.</option>
		...
		<spring:bind path="day">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="day" type="text" class="form-control " id="day"
						placeholder="" />
		...
		<spring:bind path="year">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="year" type="text" class="form-control " id="year"
						placeholder="" />
		...
		<spring:bind path="appid">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label"> <a
					href="https://openexchangerates.org/signup">How to get </a>App ID**
				</label>
				<div class="col-sm-10">
					<form:input path="appid" type="text" class="form-control "
						id="appid" placeholder="" />
					<form:errors path="appid" class="control-label" />
				</div>
			</div>
		</spring:bind>
		...
		<div class="form-group">
			<label class="col-sm-offset-2 col-sm-10">** App ID is needed to
				connect with public currency data service <a
				href="https://openexchangerates.org">openexchangerates.org</a>
			</label>
		</div>
	</form:form>
