	...
	<form:form class="form-horizontal" method="post" modelAttribute="userForm" action="${userActionUrl}">
			...
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-5">						
					...
					<form:option value="NONE" label="--- Select ---" />		
				      <option value="Afghanistan" data-alternative-spellings="AF Ø§Ù�ØºØ§Ù†Ø³ØªØ§Ù†">Afghanistan</option>
				      <option value="Ã…land Islands" data-alternative-spellings="AX Aaland Aland" data-relevancy-booster="0.5">Aland Islands</option>
				      ...
				      <option value="Austria" data-alternative-spellings="AT Ã–sterreich Osterreich Oesterreich ">Austria</option>
				      ...
				      <option value="Bangladesh" data-alternative-spellings="BD à¦¬à¦¾à¦‚à¦²à¦¾à¦¦à§‡à¦¶" data-relevancy-booster="2">Bangladesh</option>
				      ...
				      <option value="Belgium" data-alternative-spellings="BE BelgiÃ« Belgie Belgien Belgique" data-relevancy-booster="1.5">Belgium</option>
				      ...
				      <option value="Bosnia and Herzegovina" data-alternative-spellings="BA BiH Bosna i Hercegovina Ð‘Ð¾Ñ�Ð½Ð° Ð¸ Ð¥ÐµÑ€Ñ†ÐµÐ³Ð¾Ð²Ð¸Ð½Ð°">Bosnia and Herzegovina</option>
				      ...
				      <option value="China" data-relevancy-booster="3.5" data-alternative-spellings="CN Zhongguo Zhonghua Peoples Republic ä¸­å›½/ä¸­å�Ž">China</option>
				      ...
				      <option value="CÃ´te d'Ivoire" data-alternative-spellings="CI Cote dIvoire">Cote d'Ivoire</option>
				      ...
				      <option value="CuraÃ§ao" data-alternative-spellings="CW Curacao">Curacao</option>
				      <option value="Cyprus" data-alternative-spellings="CY ÎšÏ�Ï€Ï�Î¿Ï‚ KÃ½pros KÄ±brÄ±s">Cyprus</option>
				      <option value="Czech Republic" data-alternative-spellings="CZ ÄŒeskÃ¡ Ceska">Czech Republic</option>
				      <option value="Denmark" data-alternative-spellings="DK Danmark" data-relevancy-booster="1.5">Denmark</option>
				      <option value="Djibouti" data-alternative-spellings="DJ Ø¬ÙŠØ¨ÙˆØªÙŠâ€Ž Jabuuti Gabuuti">Djibouti</option>
				      ...
				      <option value="Faroe Islands" data-alternative-spellings="FO FÃ¸royar FÃ¦rÃ¸erne" data-relevancy-booster="0.5">Faroe Islands</option>
				      ...
				      <option value="France" data-alternative-spellings="FR RÃ©publique franÃ§aise" data-relevancy-booster="2.5">France</option>
				      <option value="French Guiana" data-alternative-spellings="GF">French Guiana</option>
				      <option value="French Polynesia" data-alternative-spellings="PF PolynÃ©sie franÃ§aise">French Polynesia</option>
				      <option value="French Southern Territories" data-alternative-spellings="TF">French Southern Territories</option>
				      <option value="Gabon" data-alternative-spellings="GA RÃ©publique Gabonaise">Gabon</option>
				      ...
				      <option value="Greece" data-alternative-spellings="GR Î•Î»Î»Î¬Î´Î±" data-relevancy-booster="1.5">Greece</option>
				      <option value="Greenland" data-alternative-spellings="GL grÃ¸nland" data-relevancy-booster="0.5">Greenland</option>
				      ...
				      <option value="Hong Kong" data-alternative-spellings="HK é¦™æ¸¯">Hong Kong</option>
				      ...
				      <option value="India" data-alternative-spellings="IN à¤­à¤¾à¤°à¤¤ à¤—à¤£à¤°à¤¾à¤œà¥�à¤¯ Hindustan" data-relevancy-booster="3">India</option>
				      <option value="Indonesia" data-alternative-spellings="ID" data-relevancy-booster="2">Indonesia</option>
				      <option value="Iran, Islamic Republic of" data-alternative-spellings="IR Ø§ÛŒØ±Ø§Ù†">Iran, Islamic Republic of</option>
				      <option value="Iraq" data-alternative-spellings="IQ Ø§Ù„Ø¹Ø±Ø§Ù‚â€Ž">Iraq</option>
				      <option value="Ireland" data-alternative-spellings="IE Ã‰ire" data-relevancy-booster="1.2">Ireland</option>
				      ...
				      <option value="Japan" data-alternative-spellings="JP Nippon Nihon æ—¥æœ¬" data-relevancy-booster="2.5">Japan</option>
				      ...
				      <option value="Kazakhstan" data-alternative-spellings="KZ ÒšÐ°Ð·Ð°Ò›Ñ�Ñ‚Ð°Ð½ ÐšÐ°Ð·Ð°Ñ…Ñ�Ñ‚Ð°Ð½">Kazakhstan</option>
				      ...
				      <option value="Kyrgyzstan" data-alternative-spellings="KG ÐšÑ‹Ñ€Ð³Ñ‹Ð·Ñ�Ñ‚Ð°Ð½">Kyrgyzstan</option>
				      ...
				      <option value="Libyan Arab Jamahiriya" data-alternative-spellings="LY Ù„ÙŠØ¨ÙŠØ§">Libyan Arab Jamahiriya</option>
				      ...
				      <option value="Macedonia, The Former Yugoslav Republic Of" data-alternative-spellings="MK ÐœÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ˜Ð°">Macedonia, The Former Yugoslav Republic Of</option>
				      ...
				      <option value="Mauritania" data-alternative-spellings="MR Ø§Ù„Ù…ÙˆØ±ÙŠØªØ§Ù†ÙŠØ©">Mauritania</option>
				      ...
				      <option value="Mongolia" data-alternative-spellings="MN MongÎ³ol ulus ÐœÐ¾Ð½Ð³Ð¾Ð» ÑƒÐ»Ñ�">Mongolia</option>
				      ...
				      <option value="Mozambique" data-alternative-spellings="MZ MoÃ§ambique">Mozambique</option>
				      ...
				      <option value="Nigeria" data-alternative-spellings="NG Nijeriya NaÃ­jÃ­rÃ­Ã " data-relevancy-booster="1.5">Nigeria</option>
				      ...
				      <option value="Pakistan" data-alternative-spellings="PK Ù¾Ø§Ú©Ø³ØªØ§Ù†" data-relevancy-booster="2">Pakistan</option>
				      <option value="Palau" data-alternative-spellings="PW" data-relevancy-booster="0.5">Palau</option>
				      <option value="Palestinian Territory, Occupied" data-alternative-spellings="PS Ù�Ù„Ø³Ø·ÙŠÙ†">Palestinian Territory, Occupied</option>
				      ...
				      <option value="RÃ©union" data-alternative-spellings="RE Reunion">Reunion</option>
				      <option value="Romania" data-alternative-spellings="RO Rumania Roumania RomÃ¢nia">Romania</option>
				      <option value="Russian Federation" data-alternative-spellings="RU Rossiya Ð Ð¾Ñ�Ñ�Ð¸Ð¹Ñ�ÐºÐ°Ñ� Ð Ð¾Ñ�Ñ�Ð¸Ñ�" data-relevancy-booster="2.5">Russian Federation</option>
				      <option value="Rwanda" data-alternative-spellings="RW">Rwanda</option>
				      <option value="Saint BarthÃ©lemy" data-alternative-spellings="BL St. Barthelemy">Saint BarthÃ©lemy</option>
				      ...
				      <option value="Saudi Arabia" data-alternative-spellings="SA Ø§Ù„Ø³Ø¹ÙˆØ¯ÙŠØ©">Saudi Arabia</option>
				      ...
				      <option value="Singapore" data-alternative-spellings="SG Singapura  à®šà®¿à®™à¯�à®•à®ªà¯�à®ªà¯‚à®°à¯� à®•à¯�à®Ÿà®¿à®¯à®°à®šà¯� æ–°åŠ å�¡å…±å’Œå›½">Singapore</option>
				      <option value="Sint Maarten (Dutch Part)" data-alternative-spellings="SX">Sint Maarten (Dutch Part)</option>
				      <option value="Slovakia" data-alternative-spellings="SK SlovenskÃ¡ Slovensko">Slovakia</option>
				      ...
				      <option value="Spain" data-alternative-spellings="ES EspaÃ±a" data-relevancy-booster="2">Spain</option>
				      <option value="Sri Lanka" data-alternative-spellings="LK à·�à·Šâ€�à¶»à·“ à¶½à¶‚à¶šà·� à®‡à®²à®™à¯�à®•à¯ˆ Ceylon">Sri Lanka</option>
				      <option value="Sudan" data-alternative-spellings="SD Ø§Ù„Ø³ÙˆØ¯Ø§Ù†">Sudan</option>
				      <option value="Suriname" data-alternative-spellings="SR à¤¶à¤°à¥�à¤¨à¤®à¥� Sarnam Sranangron">Suriname</option>
				      ...
				      <option value="Syrian Arab Republic" data-alternative-spellings="SY Syria Ø³ÙˆØ±ÙŠØ©">Syrian Arab Republic</option>
				      <option value="Taiwan, Province of China" data-alternative-spellings="TW å�°ç�£ è‡ºç�£">Taiwan, Province of China</option>
				      <option value="Tajikistan" data-alternative-spellings="TJ Ð¢Ð¾Ò·Ð¸ÐºÐ¸Ñ�Ñ‚Ð¾Ð½ ToÃ§ikiston">Tajikistan</option>
				      <option value="Tanzania, United Republic of" data-alternative-spellings="TZ">Tanzania, United Republic of</option>
				      <option value="Thailand" data-alternative-spellings="TH à¸›à¸£à¸°à¹€à¸—à¸¨à¹„à¸—à¸¢ Prathet Thai">Thailand</option>
				      ...
				      <option value="Turkey" data-alternative-spellings="TR TÃ¼rkiye Turkiye">Turkey</option>
				      <option value="Turkmenistan" data-alternative-spellings="TM TÃ¼rkmenistan">Turkmenistan</option>
				      ...
				      <option value="Ukraine" data-alternative-spellings="UA Ukrayina Ð£ÐºÑ€Ð°Ñ—Ð½Ð°">Ukraine</option>
				      <option value="United Arab Emirates" data-alternative-spellings="AE UAE Ø§Ù„Ø¥Ù…Ø§Ø±Ø§Øª">United Arab Emirates</option>
				      ...
				      <option value="Uzbekistan" data-alternative-spellings="UZ ÐŽÐ·Ð±ÐµÐºÐ¸Ñ�Ñ‚Ð¾Ð½ O'zbekstan Oâ€˜zbekiston">Uzbekistan</option>
				      ...
				      <option value="Vietnam" data-alternative-spellings="VN Viá»‡t Nam" data-relevancy-booster="1.5">Vietnam</option>
				      ...
				      <option value="Western Sahara" data-alternative-spellings="EH Ù„ØµØ­Ø±Ø§Ø¡ Ø§Ù„ØºØ±Ø¨ÙŠØ©">Western Sahara</option>
		...
		<spring:bind path="zipcode">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="zipcode" type="text" class="form-control " id="zipcode" placeholder="zipcode" />
		...
		<spring:bind path="street">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="street" class="form-control" id="street" placeholder="street" />
		...
		<spring:bind path="day">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="day" type="text" class="form-control " id="day" placeholder="" />
		...
		<spring:bind path="year">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="year" type="text" class="form-control " id="year" placeholder="" />
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				...
				<button type="reset" class="btn-lg btn-primary pull-right">Reset</button>
			</div>				
		</div>
	</form:form>
